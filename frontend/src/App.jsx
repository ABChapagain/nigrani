        ...
        <div className="relative p-4 w-full max-w-2xl max-h-full">
          <div className="relative bg-white rounded-lg shadow ">
            <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t ">
              <h3 className="text-xl font-semibold text-gray-900 ">{message?.numberOfElephant} (approx) Elephant Detected!!</h3>
              <button
                type="button"
            ...
            <div className="p-4 md:p-5 space-y-4">
              ...
              <p>
                ...
                <a href={message?.cameraId?.ip} target="_blank" referrerPolicy="no-referrer">
                  {' '}
                  {message?.cameraId?.ip}
                </a>
              </p>
            ...
            <div className="flex justify-between   p-4 items-center md:p-5 border-t">
              <div className="flex items-center  border-gray-200 rounded-b d">
                <Link
